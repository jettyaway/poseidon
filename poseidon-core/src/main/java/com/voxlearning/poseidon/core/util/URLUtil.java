...
public class URLUtil {
     ...
     * @return URL
     * @see ResourcesUtil#getResource(String)
     */
    public static URL getURL(String pathBaseClassLoader) {
        return ResourcesUtil.getResource(pathBaseClassLoader);
    }
     ...
     * @param clazz 指定class
     * @return URL
     * @see ResourcesUtil#getResource(String, Class)
     */
    public static URL getURL(String path, Class<?> clazz) {
        return ResourcesUtil.getResource(path, clazz);
    }
