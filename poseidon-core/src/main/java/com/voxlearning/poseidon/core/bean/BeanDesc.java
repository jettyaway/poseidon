...
import com.voxlearning.poseidon.core.collection.CaseInsensitiveMap;
...
import com.voxlearning.poseidon.core.util.TypeUtil;
	...
	private BeanDesc init() {
		...
		for (Field field : fields) {
			...
			if(fieldType == Boolean.class || fieldType == boolean.class) {
				...
				getter = ReflectUtil.getMethodsIgnoreCase(this.beanClass, StrUtil.upperFirstAndAddPre(fieldName, "is"));
				if(null == getter) {
					getter = ReflectUtil.getMethodsIgnoreCase(this.beanClass, StrUtil.genGetter(fieldName));
				}
			...
			setter = ReflectUtil.getMethodsIgnoreCase(this.beanClass, StrUtil.genSetter(fieldName), field.getType());
