package com.voxlearning.poseidon.core.collection;


import com.voxlearning.poseidon.core.convert.ConvertFactory;
import com.voxlearning.poseidon.core.exceptions.UtilException;
import com.voxlearning.poseidon.core.lang.Editor;
import com.voxlearning.poseidon.core.lang.Filter;
...
public class CollUtil {
    ...
    public static <T> Collection<T> addAll(Collection<T> collection, Object value, Class<?> elementType) {
        ...
        final ConvertFactory convert = ConvertFactory.getInstance();
