...
import static com.voxlearning.poseidon.core.util.StrUtil.*;
...
public final class Preconditions {
    ...
    public static String notBlank(String reference) {
        return notBlank(reference, "this String argument must have length; it must not be null or empty");
    }

    public static String notBlank(String reference, String errorMessageTemplate, Object... errorMessageArgs) {
